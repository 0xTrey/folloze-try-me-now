  ...
  const result = await resend.emails.send(
    {
      ...
      subject: `Your ${input.companyName} experience is ready`,
      html: `
        <div style="background:#f4f4fb;padding:42px 20px;font-family:Inter,Arial,sans-serif;color:#1c293f">
          <div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid #e6e8f0;border-radius:24px;padding:38px">
            ...
            <p style="font-size:16px;line-height:1.55;color:#42536c;margin:0 0 28px">We saved the ${escapeHtml(input.companyName)} experience you created. Use the link below to open it or share it with your team.</p>
