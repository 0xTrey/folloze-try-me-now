...
const headers = {
  ...
  "Content-Security-Policy":
    "default-src 'none'; img-src 'self' https: data:; style-src 'unsafe-inline' https:; script-src 'unsafe-inline'; connect-src 'none'; frame-ancestors 'self' https://*.folloze.com http://localhost:*; base-uri 'none'; form-action 'none'"
};
