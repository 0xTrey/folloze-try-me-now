...
1. The user's July 30 through August 12 instructions and accepted defaults are
...
When a July 30 through August 12 decision conflicts with the June 1 artifact,
...
On 2026-08-12, D-036 clarified D-027 and D-035: visual review may recommend or
trigger a bounded repair, but it does not suppress a usable artifact. Brand
evidence still cannot be fabricated or mislabeled; the system instead renders an
honest neutral, type-led, or no-asset treatment and continues refinement.

On 2026-08-12, D-037 superseded D-021. Vercel is authoritative, and the
GitHub default branch remains `codex/visual-v1`; `production` is the intentional
